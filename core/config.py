...
class Settings(BaseSettings):
    ...
    ALLOWED_EXTENSIONS: Set[str] = {'png', 'jpg', 'jpeg', 'xlsx', 'pdf', 'docx', 'txt'}
    ...
    MAX_EXTRACTED_TEXT_LENGTH: int = 300000  # Maximum characters for combined extracted text sent to LLM
