...
class TestFileTypeDetection:
    ...
    def test_process_uploaded_file_image_types(self):
        ...
        for ext in image_extensions:
            ...
            with patch('document_processor.prepare_image_for_llm') as mock_image_processor:
...
class TestImageProcessor:
    ...
    def test_prepare_image_for_llm_corrupted_image(self, mock_image_open):
        ...
        mock_image_open.side_effect = Image.UnidentifiedImageError("Cannot identify image")
    ...
    @patch('PIL.Image.open')
    @patch('mimetypes.guess_type')
    def test_prepare_image_for_llm_unknown_mime_type(self, mock_guess_type, mock_image_open):
...
class TestFilenameHandling:
    ...
    def test_filename_extraction_from_path(self):
        ...
        test_cases = [
            ...
            (os.path.normpath('C:/Users/test/file.xlsx'), 'file.xlsx'),  # Use forward slashes and normalize
